; Zorke's DIB Shell
; MODIFIED FOR R0B0H0B0'S VIRUS PROJECT
; *********************
...
.data
	...
	Section			db 0
	; MESSAGES!
	rzr_msg			DB "        PRESENTS ...        ",0AAH
                              DB "                            ",0AAH
					DB "   VIRUS.WIN32.R0B0H0B0     ",0AAH
					DB "  -----------------------   ",0AAH
					DB "         VIRUS FOR          ",0AAH
					DB "    PE32 EXE FILES ONLY.    ",0AAH
					DB "  -----------------------   ",0AAH
					DB "         THANX TO:          ",0AAH
					DB "  R0B0H0B0 ... VIRUS CODE   ",0AAH
					DB "  ZORKE ....... STARFIELD   ",0AAH
					DB "  DR0PTPACKET ...... TUNE   ",0AAH
					DB "  -----------------------   ",0AAH
					DB "                            ",0
 	scroller		DB "                                     "
	...
	.elseif uMsg == WM_TIMER
		.if wParam == 1
			...
			.elseif Section == 1
				...
				invoke DXYCPSineScroll, 340, offset scroller, offset font_pal, offset font_img, 960, 16, 16, cBuffer
				invoke BlitImg, 71, 5, offset razor_pal, offset razor_img, 564, 104, 0
